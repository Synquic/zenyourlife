        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="text-center p-4 sm:p-8 border-r border-b md:border-b-0 border-gray-200">
              <h3 className="text-2xl sm:text-4xl font-bold text-gray-800 mb-1 sm:mb-2">100+</h3>
            ...
            <div className="text-center bg-[#B8860B] p-4 sm:p-8 border-b md:border-b-0 md:border-r border-gray-200">
              <h3 className="text-2xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">50+</h3>
              <p className="text-xs sm:text-sm text-white">
                {t('home.certified_therapists')}
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm">
              <div className="bg-[#B8860B] rounded-lg sm:rounded-xl w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mb-3 sm:mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">
                {t('home.customized_treatments')}
              </h3>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                {t('home.customized_desc')}
              </p>
            </div>
            ...
            {/* Luxurious Ambience */}
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm sm:col-span-2 md:col-span-1">
              <div className="bg-[#B8860B] rounded-lg sm:rounded-xl w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mb-3 sm:mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 sm:h-6 sm:w-6 text-white"
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">
                {t('home.luxurious_ambience')}
              </h3>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                {t('home.ambience_desc')}
              </p>
            </div>
          </div>
        </div>
