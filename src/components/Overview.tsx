        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition text-center">
            ...
            <p className="text-gray-600 text-sm">
              We don't do conveyor belt spa vibes — it's about caring.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition text-center">
            ...
            <p className="text-gray-600 text-sm">
              No inflated marketing, no wellness jargon. It's holistic without drama.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition text-center">
            ...
            <p className="text-gray-600 text-sm">
              Real, fair pricing for things that actually work.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-2xl hover:shadow-xl transition text-center">
            ...
            <p className="text-gray-600 text-sm">
              We see the bigger picture — it's how you feel, rest, and evolve.
            </p>
          </div>
